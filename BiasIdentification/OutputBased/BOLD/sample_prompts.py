...
if __name__ == "__main__":
    gender_samples = sample_prompts(Path(__file__).resolve().parents[3] / 'Datasets/gender_prompt.json', 3)
    race_samples = sample_prompts(Path(__file__).resolve().parents[3] / 'Datasets/race_prompt.json', 3)
